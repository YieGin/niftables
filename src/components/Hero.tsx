...
const Hero = () => {
  ...
  return (
    <div className="lg:h-screen h-[75vh] relative overflow-hidden bg-gradient-to-t from-black from-0% via-[#3D8BFF] via-47% to-[#AB23FF] to-100%">
      <video
        autoPlay
        loop
        muted
      ...
      <div className="inset-0 absolute flex flex-col px-5 md:px-20 2xl:px-60 justify-center h-full mt-28 md:mt-[14%]">
        ...
        <div className="md:w-max font-satoshi-Bold text-base md:text-[22px] mt-10">
          ...
          <p className="bg-gradient-to-r from-[#3D8BFF] to-[#AB23FF] inline-block text-transparent bg-clip-text my-1 mb-2 md:text-[22px]">
